...
@section('content')
    <div class="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
        <p class="font-mono text-sm font-medium text-zinc-500 dark:text-zinc-400">403</p>
        <h1 class="mt-3 text-2xl font-semibold text-zinc-900 dark:text-zinc-100">Akses ditolak</h1>
